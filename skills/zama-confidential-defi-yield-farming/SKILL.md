...
short_description: Professional v6.1.0 elite guide to confidential defi yield farming on Zama FHEVM.
category: Finance
difficulty: Advanced
...
// Implementation of confidential defi yield farming
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the confidential defi yield farming implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
