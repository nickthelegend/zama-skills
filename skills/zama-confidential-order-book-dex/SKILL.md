...
short_description: Professional v6.1.0 elite guide to confidential order book dex on Zama FHEVM.
category: Finance
difficulty: Advanced
...
// Implementation of confidential order book dex
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the confidential order book dex implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
