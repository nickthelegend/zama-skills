...
short_description: Professional v6.1.0 elite guide to confidential reputation system on Zama FHEVM.
category: Security
difficulty: Advanced
...
// Implementation of confidential reputation system
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the confidential reputation system implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
