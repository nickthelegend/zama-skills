...
description: Production-grade v6.1.0 elite guide to confidential reputation system on Zama FHEVM.
category: Security
difficulty: Advanced
version: "6.1.0"
---
...
## Overview
This skill provides a comprehensive, production-grade implementation of confidential reputation system using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract confidentialreputationsystem {
    ...
    // Core business logic for confidential reputation system
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this confidential reputation system implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."