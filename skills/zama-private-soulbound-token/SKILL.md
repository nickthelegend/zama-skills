---
name: zama-private-soulbound-token
description: Production-grade v6.1.0 elite guide to private soulbound token on Zama FHEVM.
category: Foundation
difficulty: Advanced
version: "6.1.0"
---
...
## Overview
This skill provides a comprehensive, production-grade implementation of private soulbound token using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract privatesoulboundtoken {
    ...
    // Core business logic for private soulbound token
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this private soulbound token implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."