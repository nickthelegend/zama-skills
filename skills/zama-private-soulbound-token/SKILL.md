...
short_description: Professional v6.1.0 elite guide to private soulbound token on Zama FHEVM.
category: Foundation
difficulty: Advanced
...
// Implementation of private soulbound token
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the private soulbound token implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
