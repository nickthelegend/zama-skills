...
short_description: Professional v6.1.0 elite guide to private cross chain bridge on Zama FHEVM.
category: Foundation
difficulty: Advanced
...
// Implementation of private cross chain bridge
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the private cross chain bridge implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
