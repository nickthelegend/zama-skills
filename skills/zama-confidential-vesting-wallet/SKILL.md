...
description: Production-grade v6.1.0 elite guide to confidential vesting wallet on Zama FHEVM.
category: Finance
difficulty: Advanced
version: "6.1.0"
---
...
## Overview
This skill provides a comprehensive, production-grade implementation of confidential vesting wallet using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract confidentialvestingwallet {
    ...
    // Core business logic for confidential vesting wallet
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this confidential vesting wallet implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."