...
short_description: Professional v6.1.0 elite guide to confidential otc trade on Zama FHEVM.
category: Finance
difficulty: Advanced
...
// Implementation of confidential otc trade
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the confidential otc trade implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
