...
short_description: Professional v6.1.0 elite guide to fhevm forge foundry integration on Zama FHEVM.
category: Operations
difficulty: Advanced
...
// Implementation of fhevm forge foundry integration
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the fhevm forge foundry integration implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
