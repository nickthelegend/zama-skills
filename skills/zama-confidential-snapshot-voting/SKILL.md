...
description: Production-grade v6.1.0 elite guide to confidential snapshot voting on Zama FHEVM.
category: Governance
difficulty: Advanced
version: "6.1.0"
---
...
## Overview
This skill provides a comprehensive, production-grade implementation of confidential snapshot voting using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract confidentialsnapshotvoting {
    ...
    // Core business logic for confidential snapshot voting
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this confidential snapshot voting implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."