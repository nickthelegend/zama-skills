---
name: zama-confidential-erc20-token
description: Production-grade v6.1.0 elite guide to confidential erc20 token on Zama FHEVM.
category: Finance
difficulty: Advanced
version: "6.1.0"
---

# Zama CONFIDENTIAL ERC20 TOKEN

## Overview
This skill provides a comprehensive, production-grade implementation of confidential erc20 token using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract confidentialerc20token {
    ...
    // Core business logic for confidential erc20 token
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this confidential erc20 token implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."