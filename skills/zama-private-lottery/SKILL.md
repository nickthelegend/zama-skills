...
short_description: Professional v6.1.0 elite guide to private lottery on Zama FHEVM.
category: Foundation
difficulty: Advanced
...
// Implementation of private lottery
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the private lottery implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
