...
description: Production-grade v6.1.0 elite guide to private lottery on Zama FHEVM.
category: Foundation
difficulty: Advanced
version: "6.1.0"
---
...
## Overview
This skill provides a comprehensive, production-grade implementation of private lottery using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract privatelottery {
    ...
    // Core business logic for private lottery
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this private lottery implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."