...
short_description: Professional v6.1.0 elite guide to solidity encrypted types and operations on Zama FHEVM.
category: Foundation
difficulty: Advanced
...
// Implementation of solidity encrypted types and operations
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the solidity encrypted types and operations implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
