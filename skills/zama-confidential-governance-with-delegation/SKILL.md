---
name: zama-confidential-governance-with-delegation
description: Production-grade v6.1.0 elite guide to confidential governance with delegation on Zama FHEVM.
category: Governance
difficulty: Advanced
version: "6.1.0"
---
...
## Overview
This skill provides a comprehensive, production-grade implementation of confidential governance with delegation using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract confidentialgovernancewithdelegation {
    ...
    // Core business logic for confidential governance with delegation
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this confidential governance with delegation implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."