---
name: zama-confidential-dynamic-nft
description: Production-grade v6.1.0 elite guide to confidential dynamic nft on Zama FHEVM.
category: Foundation
difficulty: Advanced
version: "6.1.0"
---

# Zama CONFIDENTIAL DYNAMIC NFT

## Overview
This skill provides a comprehensive, production-grade implementation of confidential dynamic nft using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract confidentialdynamicnft {
    ...
    // Core business logic for confidential dynamic nft
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this confidential dynamic nft implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."