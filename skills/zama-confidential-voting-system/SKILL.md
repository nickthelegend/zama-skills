...
description: Production-grade v6.1.0 elite guide to confidential voting system on Zama FHEVM.
category: Governance
difficulty: Advanced
version: "6.1.0"
---
...
## Overview
This skill provides a comprehensive, production-grade implementation of confidential voting system using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract confidentialvotingsystem {
    ...
    // Core business logic for confidential voting system
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this confidential voting system implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."