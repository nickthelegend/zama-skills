...
short_description: Professional v6.1.0 elite guide to confidential insurance claims on Zama FHEVM.
category: Foundation
difficulty: Advanced
...
// Implementation of confidential insurance claims
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the confidential insurance claims implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
