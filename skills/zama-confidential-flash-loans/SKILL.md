...
description: Production-grade v6.1.0 elite guide to confidential flash loans on Zama FHEVM.
category: Finance
difficulty: Advanced
version: "6.1.0"
---
...
## Overview
This skill provides a comprehensive, production-grade implementation of confidential flash loans using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract confidentialflashloans {
    ...
    // Core business logic for confidential flash loans
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this confidential flash loans implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."