...
description: Production-grade v6.1.0 elite guide to private identity verification on Zama FHEVM.
category: Security
difficulty: Advanced
version: "6.1.0"
---
...
## Overview
This skill provides a comprehensive, production-grade implementation of private identity verification using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract privateidentityverification {
    ...
    // Core business logic for private identity verification
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this private identity verification implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."