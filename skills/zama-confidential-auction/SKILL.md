---
name: zama-confidential-auction
description: Production-grade v6.1.0 elite guide to confidential auction on Zama FHEVM.
category: Finance
difficulty: Advanced
version: "6.1.0"
---

# Zama CONFIDENTIAL AUCTION

## Overview
This skill provides a comprehensive, production-grade implementation of confidential auction using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract confidentialauction {
    ...
    // Core business logic for confidential auction
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this confidential auction implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."