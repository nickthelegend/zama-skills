...
short_description: Professional v6.1.0 elite guide to confidential auction on Zama FHEVM.
category: Finance
difficulty: Advanced
...
// Implementation of confidential auction
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the confidential auction implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
