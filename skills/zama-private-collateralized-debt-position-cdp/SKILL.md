...
short_description: Professional v6.1.0 guide to private collateralized debt position cdp on FHEVM.
category: Foundation
difficulty: Advanced
...
## Overview
Detailed production-grade documentation for private collateralized debt position cdp using Zama's FHEVM.
...
## AI Agent Prompt
> "Analyze this implementation of private collateralized debt position cdp on Zama FHEVM. Ensure that all security practices are followed and suggest optimizations for gas and performance."
