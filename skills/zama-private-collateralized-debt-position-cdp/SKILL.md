---
name: zama-private-collateralized-debt-position-cdp
description: Production-grade v6.1.0 elite guide to private collateralized debt position cdp on Zama FHEVM.
category: Foundation
difficulty: Advanced
version: "6.1.0"
---

# Zama PRIVATE COLLATERALIZED DEBT POSITION CDP

## Overview
This skill provides a comprehensive, production-grade implementation of private collateralized debt position cdp using Zama's Fully Homomorphic Encryption (FHE) Virtual Machine.
...
contract privatecollateralizeddebtpositioncdp {
    ...
    // Core business logic for private collateralized debt position cdp
...
## AI Agent Prompt
> "Act as a Zama FHEVM Senior Architect. Review this private collateralized debt position cdp implementation. Focus on identifying potential information leaks through gas usage patterns or incorrect application of the branchless programming paradigm."