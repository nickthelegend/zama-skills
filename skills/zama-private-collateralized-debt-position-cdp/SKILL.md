...
short_description: Professional v6.1.0 elite guide to private collateralized debt position cdp on Zama FHEVM.
category: Foundation
difficulty: Advanced
...
// Implementation of private collateralized debt position cdp
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the private collateralized debt position cdp implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
