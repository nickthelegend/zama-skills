...
short_description: Professional v6.1.0 elite guide to fhevm coprocessor native opcodes on Zama FHEVM.
category: Foundation
difficulty: Advanced
...
// Implementation of fhevm coprocessor native opcodes
...
## AI Agent Prompt
> "Act as a Zama FHEVM Security Auditor. Review the fhevm coprocessor native opcodes implementation for potential side-channel leaks via gas patterns or incorrect FHE.select usage."
